...
<body>
    <div class="page-container">
        ...
        <div id="JumptoSection">
            ...
            <div class="countries">
                ...
                <select onchange="javascript:scrollToAnchor(this.value, 100);">
                        ...
                        <option value="repeat-offenders-grocer">Repeat Offenders - Grocers</option>
        ...
        <h1 id="">Food Standards Agency - Food Alerts Analysis</h1>
            ...
            <img src="img/fsa-word-cloud.png" style="width:75%"> 
...
<li>[2] European Food Safety Agency (EFSA). <a href="https://www.efsa.europa.eu/en">https://www.efsa.europa.eu/en</a> </li></ul>
        ...
        <p>The number of products for which alerts are issued reported here, is a lot lower than reality. Prior to July 2024, 
            only products mentioned in the search results alert title and sub text are included. Post July 2024, these are being manually added.
        </p>
...
<br><a href="#">Top</a>
  ...
  <thead>
    <tr style="text-align: right;">
      ...
      <th style="text-align:center; ">Supplier Type</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:center; ">Grocer % of total</td>
    ...
    <tr>
      ...
      <td style="text-align:center; "><b>67</b></td>
      ...
      <td style="text-align:center; "><b>176</b></td>
