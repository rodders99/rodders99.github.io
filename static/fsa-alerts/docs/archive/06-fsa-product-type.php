...
<body>
    <div class="page-container">
        ...
        <div id="JumptoSection">
            ...
            <div class="countries">
                ...
                <select onchange="javascript:scrollToAnchor(this.value, 100);">
                        ...
                        <option value="ready-meal-ready-to-eat-alert-category">Ready Meals / Ready to Eat, Distribution of Safety Alert Categories</option>
                        <option value="ready-meal-ready-to-eat-alert-types">Ready Meals / Ready to Eat, Distribution of Safety Alert Contaminant Types</option>
                        ...
                        <option value="sauces-condiments-alert-category">Sauces / Condiments, Distribution of Safety Alert Categories</option>
                        <option value="sauces-condiments-alert-types">Sauces / Condiments, Distribution of Safety Alert Contaminant Types</option>


                        <option value="vegetables-processed-alert-category">Processed Vegetables, Distribution of Safety Alert Categories</option>
                        <option value="vegetables-processed-alert-types">Processed Vegetables, Distribution of Safety Alert Contaminant Types</option>

                        <option value="bread-baked-goods-alert-category">Bread / Baked Goods, Distribution of Safety Alert Categories</option>
                        <option value="bread-baked-goods-alert-types">Bread / Baked Goods, Distribution of Safety Alert Contaminant Types</option>
                        
                        <option value="cheese-alert-category">Cheese, Distribution of Safety Alert Categories</option>
                        <option value="cheese-alert-types">Cheese, Distribution of Safety Alert Contaminant Types</option>
                        
                        <option value="fish-processed-alert-category">Ready Meals / Ready to Eat, Distribution of Safety Alert Categories</option>
                        <option value="fish-processed-alert-types">Ready Meals / Ready to Eat, Distribution of Safety Alert Contaminant Types</option>

                        <option value="pork-alert-category">Processed Pork, Distribution of Safety Alert Categories</option>
                        <option value="pork-alert-types">Processed Pork, Distribution of Safety Alert Contaminant Types</option>
                        <option value="chicken-processed-alert-category">Processed Chicken, Distribution of Safety Alert Categories</option>
                        <option value="chicken-processed-alert-types">Processed Chicken, Distribution of Safety Alert Contaminant Types</option>
                        <option value="dairy-alert-category">Dairy, Distribution of Safety Alert Categories</option>
                        <option value="dairy-alert-types">Dairy, Distribution of Safety Alert Contaminant Types</option>
                        <option value="nutrition-supplements-alert-category">Nutrition / Supplements, Distribution of Safety Alert Categories</option>
                        <option value="nutrition-supplements-alert-types">Nutrition / Supplements, Distribution of Safety Alert Contaminant Types</option>
                        <option value="alcohol-alert-category">Alcohol, Distribution of Safety Alert Categories</option>
                        <option value="alcohol-alert-types">Alcohol, Distribution of Safety Alert Contaminant Types</option>
                        <option value="sandwiches-wraps-alert-category">Sandwiches / Wraps, Distribution of Safety Alert Categories</option>
                        <option value="sandwiches-wraps-alert-types">Sandwiches / Wraps, Distribution of Safety Alert Contaminant Types</option>
                        <option value="nuts-seeds-alert-category">Nuts / Seeds, Distribution of Safety Alert Categories</option>
                        <option value="nuts-seeds-alert-types">Nuts / Seeds, Distribution of Safety Alert Contaminant Types</option>
                        <option value="baby-foods-formula-alert-category">Baby Foods / Formula, Distribution of Safety Alert Categories</option>
                        <option value="baby-foods-formula-alert-types">Baby Foods / Formula, Distribution of Safety Alert Contaminant Types</option>
                        <option value="pet-food-alert-category">Pet Foods, Distribution of Safety Alert Categories</option>
                        <option value="pet-food-alert-types">Pet Foods, Distribution of Safety Alert Contaminant Types</option>
                        <option value="herbs-spices-alert-category">Herbs / Spices, Distribution of Safety Alert Categories</option>
                        <option value="herbs-spices-alert-types">Herbs / Spices, Distribution of Safety Alert Contaminant Types</option>
                        <option value="beef-processed-alert-category">Processed Beef, Distribution of Safety Alert Categories</option>
                        <option value="beef-processed-alert-types">Processed Beef, Distribution of Safety Alert Contaminant Types</option>
                        <option value="cereal-alert-category">Cereal, Distribution of Safety Alert Categories</option>
                        <option value="cereal-alert-types">Cereal, Distribution of Safety Alert Contaminant Types</option>
                        <option value="soft-drinks-alert-category">Soft Drinks, Distribution of Safety Alert Categories</option>
                        <option value="soft-drinks-alert-types">Soft Drinks, Distribution of Safety Alert Contaminant Types</option>
        ...
        <tr>
                <td><a href="img/ready-meal-ready-to-eat-contaminant-pie.png"><img src="img/ready-meal-ready-to-eat-contaminant-pie.png" style="width:100%"></a></td>
...
<br><a href="#">Top</a>
        ...
        <h2>Confectionery</h2>
            ...
            <h3 id="confectionery-alert-category">Confectionery - Safety Alert Category Distribution</h3>
                ...
                <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
                <tr>
                        <td><a href="img/confectionery-contaminant-pie.png"><img src="img/confectionery-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="sauces-condiments-alert-category">Sauces / Condiments - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/sauces-condiments-contaminant-pie.png"><img src="img/sauces-condiments-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="vegetables-processed-alert-category">Vegetables Processed - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/vegetables-processed-contaminant-pie.png"><img src="img/vegetables-processed-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="bread-baked-goods-alert-category">Bread / Baked Goods - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/bread-baked-goods-contaminant-pie.png"><img src="img/bread-baked-goods-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="cheese-alert-category">Cheese - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/cheese-contaminant-pie.png"><img src="img/cheese-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="fish-processed-alert-category">Processed Fish - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/fish-processed-contaminant-pie.png"><img src="img/fish-processed-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="pork-processed-alert-category">Processed Pork - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/pork-processed-contaminant-pie.png"><img src="img/pork-processed-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="chicken-processed-alert-category">Processed Chicken - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/chicken-processed-contaminant-pie.png"><img src="img/chicken-processed-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="dairy-alert-category">Dairy - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/dairy-contaminant-pie.png"><img src="img/dairy-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="nutrition-supplements-alert-category">Nutrition Supplements - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/nutrition-supplements-contaminant-pie.png"><img src="img/nutrition-supplements-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="alcohol-alert-category">Alcohol - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/alcohol-contaminant-pie.png"><img src="img/alcohol-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="sandwiches-wraps-alert-category">Sandwiches / Wraps - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/sandwiches-wraps-contaminant-pie.png"><img src="img/sandwiches-wraps-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="nuts-seeds-alert-category">Nuts / Seeds - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/nuts-seeds-contaminant-pie.png"><img src="img/nuts-seeds-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="baby-foods-formula-alert-category">Baby Foods / Formula - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/baby-foods-formula-contaminant-pie.png"><img src="img/baby-foods-formula-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="pet-food-alert-category">Pet Foods - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/pet-food-contaminant-pie.png"><img src="img/pet-food-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="herbs-spices-alert-category">Herbs / Spices - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/herbs-spices-contaminant-pie.png"><img src="img/herbs-spices-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="beef-processed-alert-category">Processed Beef - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/beef-processed-contaminant-pie.png"><img src="img/beef-processed-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="cereal-alert-category">Cereals - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/cereal-contaminant-pie.png"><img src="img/cereal-contaminant-pie.png" style="width:100%"></a></td>
...
<h3 id="soft-drinks-alert-category">Soft Drinks - Safety Alert Category Distribution</h3>
    ...
    <table class="dataframe datatable" style="width:100%; margin: 0 auto;">
    <tr>
            <td><a href="img/soft-drinks-contaminant-pie.png"><img src="img/soft-drinks-contaminant-pie.png" style="width:100%"></a></td>
