...
<li>In 2023 833 safety alerts were issued for products containing BMHCA</li>
  ...
  <p>So far in 2024 around 17% of all alerts issued so far this year have been for Cosmetics</p>
...
<h3 >Alerts by Submitting Country 2022 Vs 2023</h3>

<p>Comparing up to the noted week for each year.</p>

<div class="datatable-container" id="all-submitting-country-LYvsTY">
  <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
  <tbody> 
    <tr><td>
...
<h3 >Annual Alerts by Submitting Country Percentage of Total</h3>
...
<div class="datatable-container" id="all-top15-kfs">
  ...
  <tbody> 
    ...
    <tr>
      ...
      <td style="text-align:center; width:47.1%" >
      ...
      <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=unknown">Unknown</A></th>
        <td>
          <a href="https://rodders.me/safetygate/img-2024/unknown-total-alerts-issued-vs-row-ly-vs-ty.png">
            ...
            <td style="text-align:center; width:48.5%" >
              ...
              <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
                <tbody>
                  <tr>
                    ...
                    <td id="all-product-cat-0-action-required-LYvsTY"  style="width:50%">
                    <a href= "https://rodders.me/safetygate/img-2024/all-countries-product-0-action-required-ly-vs-ty.png">
                      ...
                      <td  id="all-product-cat-0-responsible-LYvsTY" style="width:50%">
