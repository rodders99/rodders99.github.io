  ...
  <div class="page-container">
    ...
    <div class="countries">
      ...
      <div class="country">
        ...
        <option value="header-7">Map Plot Previous Year Vs Current Year</option>
        <option value="header-8">Product Categories</option>
        <option value="header-9">What happened between 2022-2023?</option>
        <option value="header-10">Cosmetics</option>
        <option value="header-14">The European Cosmetics Industry</option>
        <option value="header-15">Cosmetics Sub Categories affected by the ban</option>
        <option value="header-16">Cosmetic Products Safety Gate Alerts, Country of origin</option>
        <option value="header-17">Italy and Cosmetics</option>
        <option value="header-18">Cosmetic Products Safety Gate Alerts, Top 30 Brands</option>
        <option value="header-19">Which countries' products get the most alerts?</option>
        <option value="header-20">Country of Product Origin</option>
        <option value="header-21">Risk Category</option>
        <option value="header-22">Product Category mapped to Risk Category</option>
        <option value="header-23">Action Required</option>
        <option value="header-24">Responsible Party</option>
        <option value="header-25">Top 30 Worldwide brands for Safety Alerts</option>
        <option value="header-26">Top 15 Countries - Key Fact sheets</option>
        <option value="header-27">Cumulative, Annual and YoY change / Top3 Categories (Risk/Product)</option>
        <option value="header-28">Top 3 Worldwide Product Categories</option>
        <option value="header-29">#1 - Top 3 Product Categories</option>
        <option value="header-30">Total, Annual and Cumulative Alerts</option>
        <option value="header-31">#1 - Submitting Country</option>
        <option value="header-32">#1 - Risk Category</option>
        <option value="header-33">#1 - Counterfeit </option>
        <option value="header-35">#1 - Compulsory / Voluntary Action Required</option>
        <option value="header-36">#1 - Compulsory / Voluntary Responsible Party</option>
        <option value="header-37">#1 - Top Brands for Safety Alerts</option>
        <option value="header-38">#2 - Top 3 Product Categories</option>
        <option value="header-39">#2 - Total, Annual and Cumulative Alerts</option>
        <option value="header-40">#2 - Submitting Country</option>
        <option value="header-41">#2 - Risk Category</option>
        <option value="header-42">#2 - Counterfeit </option>
        <option value="header-43">#2 - Compulsory / Voluntary Action Required</option>
        <option value="header-44">#2 - Compulsory / Voluntary Responsible Party</option>
        <option value="header-45">#2 - Top Brands for Safety Alerts</option>
        <option value="header-46">#3 - Top 3 Product Categories</option>
        <option value="header-47">#3 - Total, Annual and Cumulative Alerts</option>
        <option value="header-48">#3 - Submitting Country</option>
        <option value="header-49">#3 - Risk Category</option>
        <option value="header-50">#3 - Counterfeit </option>
        <option value="header-51">#3 - Compulsory / Voluntary Action Required </option>
        <option value="header-52">#3 - Compulsory / Voluntary Responsible Party</option>
        <option value="header-53">#3 - Top Brands for Safety Alerts</option>
    ...
    <div class="datatable-container">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/number-of-alerts-validated-on-safetygate-from-2005-to-2023.png"
                id="PresentAnnual">
                <img
                  src="https://rodders.me/safetygate/img-2023/number-of-alerts-validated-on-safetygate-from-2005-to-2023.png" /></a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="datatable-container" id="all-AnnualGeoplot">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          <tr>
            <td> <a href="https://rodders.me/safetygate/img-2023/all-countries-submitting-country-geo-plot.png">
                <img src="https://rodders.me/safetygate/img-2023/all-countries-submitting-country-geo-plot.png">
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <ul>
      <li>In 2023 1,072 safety alerts were issued for products containing the chemical BMHCA</li>
    ...
    <p>
      ...
      included in so many products. While an individual exposure poses a minimal risk, cumulative exposure from the use of 
      multiple products containing this chemical increases the risk considerably. </p>
    <p>
    ...
    <div style="background-color: white; display: inline-block; ">
      <img src="https://rodders.me/safetygate/img-2023/icons/bmhca-molecule.png"><br> BMHCA "Lilial" Molecule
    </div>
    ...
    <div class="datatable-container" id="all-Cosmetics-Coo">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/cosmetics-country-of-origin-ly-vs-ty.png">
                <img src="https://rodders.me/safetygate/img-2023/cosmetics-country-of-origin-ly-vs-ty.png"></a>
    ...
    <h1>Top 15 Countries - Key Fact sheets</h1>
    ...
    <h2>Cumulative, Annual and YoY change / Top3 Categories (Risk/Product)</h2>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align:center; width:45%"><a
                href="https://rodders.me/safetygate/img-2023/china-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/china-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;">
              <a href="https://rodders.me/safetygate/img-2023/china-annual-cumulative-alerts-and-yoy-change.png">
                <img src="https://rodders.me/safetygate/img-2023/china-annual-cumulative-alerts-and-yoy-change.png"></a>
            </td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=china">China</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/china-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/china-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=france">France</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/france-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/france-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/france-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/france-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=france">France</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/france-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/france-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=germany">Germany</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/germany-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/germany-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/germany-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/germany-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=germany">Germany</A></th>
            <td colspan="2" style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/germany-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/germany-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=india">India</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/india-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/india-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/india-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/india-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=india">India</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/india-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/india-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=italy">Italy</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/italy-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/italy-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/italy-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/italy-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=italy">Italy</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/italy-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/italy-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=japan">Japan</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/japan-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/japan-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/japan-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/japan-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=japan">Japan</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/japan-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/japan-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=poland">Poland</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/poland-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/poland-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/poland-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/poland-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=poland">Poland</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/poland-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/poland-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=poland">Spain</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/spain-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/spain-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/spain-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/spain-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=spain">Spain</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/spain-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/spain-top3s"></a></td>
          </tr>
          ...
          <tr>
            ...
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/sweden-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/sweden-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/sweden-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/sweden-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=sweden">Sweden</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/sweden-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/sweden-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=taiwan">Taiwan</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/taiwan-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/taiwan-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/taiwan-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/taiwan-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=taiwan">Taiwan</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/taiwan-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/taiwan-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=uk">UK</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/uk-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/uk-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/uk-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/uk-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=uk">UK</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/uk-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/uk-top3s"></a></td>
          </tr>

          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=usa">USA</A></th>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/usa-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/usa-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/usa-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/usa-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=usa">USA</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/usa-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/usa-top3s"></a></td>
          </tr>
          ...
          <tr>
            ...
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/other-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/other-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/other-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/other-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=other">Other</A></th>
            <td colspan="2" style="text-align:center;"><a href="https://rodders.me/safetygate/img-2023/other-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/other-top3s"></a></td>
          </tr>
          ...
          <tr>
            ...
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/unknown-annual-and-cumulative-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/unknown-annual-and-cumulative-alerts.png"></a></td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/unknown-annual-cumulative-alerts-and-yoy-change.png"><img
                  src="https://rodders.me/safetygate/img-2023/unknown-annual-cumulative-alerts-and-yoy-change.png"></a></td>
          </tr>
          <tr>
            <td><A href="/safetygate/docs/eu-safetygate-report-2023-country.html?country1=unknown">Unknown</A></th>
            <td colspan="2" style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/unknown-top3s.png"><img
                  src="https://rodders.me/safetygate/img-2023/unknown-top3s"></a></td>
          </tr>
          ...
          <tr>
            <td style="text-align:center; width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-0-annual-and-cumulative-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-annual-and-cumulative-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-annual-cumulative-alerts-and-yoy-change.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-annual-cumulative-alerts-and-yoy-change.png"></a>
            </td>
          </tr>
          <tr>
        </tbody>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="datatable-container" id="all-product-cat-0-submitting-country-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-annual-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-annual-percentage.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-submitting-country-annual-percentage.png"></a>
            </td>
          </tr>
    ...
    <div class="datatable-container" id="all-product-cat-0-risk-category-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-risk-category-annual-alerts.png"><img
    ...
    <div class="datatable-container" id="all-product-cat-0-counterfeit-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-counterfeit-annual-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-counterfeit-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-counterfeit-annual-alerts-percentage.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-counterfeit-annual-alerts-percentage.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-0-action-required-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-action-required-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-0-responsible-party-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-responsible-party-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="datatable-container" id="all-product-cat-0-top30-brands">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tbody>
          <tr>
            <td style="text-align: center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-0-top-30-brands-for-safety-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-0-top-30-brands-for-safety-alerts.png">
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          ...
          <tr>
            <td style="text-align:center; width:50%"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-1-annual-and-cumulative-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-annual-and-cumulative-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-1-annual-cumulative-alerts-and-yoy-change.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-annual-cumulative-alerts-and-yoy-change.png"></a>
            </td>
          </tr>
          <tr>
        </tbody>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="text-align:center; width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-annual-percentage.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-submitting-country-annual-percentage.png"></a>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align:center; width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-risk-category-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-risk-category-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-1-risk-category-annual-alerts-percentage.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-risk-category-annual-alerts-percentage.png"></a>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align:center; width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-counterfeit-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img-2023/all-countries-product-1-counterfeit-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-1-counterfeit-annual-alerts-percentage.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-counterfeit-annual-alerts-percentage.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-annual-alerts.png"></a>
            </td>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-total-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-action-required-total-alerts.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-annual-alerts.png"></a>
            </td>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-total-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-1-responsible-party-total-alerts.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="text-align:center; width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-annual-and-cumulative-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-annual-and-cumulative-alerts.png"></a>
            </td>
            <td style="text-align:center;">
              <a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-annual-cumulative-alerts-and-yoy-change.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-annual-cumulative-alerts-and-yoy-change.png"></a>
            </td>
          </tr>
          <tr>
        </tbody>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="datatable-container" id="all-product-cat-2-submitting-country-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center; width:50%"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-annual-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-annual-percentage.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-submitting-country-annual-percentage.png"></a>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-ly-vs-ty.png">
                <img src="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-ly-vs-ty.png"></p>
              </a>
            </td>
          </tr>
        </tbody>
    ...
    <div class="datatable-container" id="all-product-cat-2-risk-category-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center; width:50%"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-annual-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-annual-alerts-percentage.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-risk-category-annual-alerts-percentage.png"></a>
            </td>
          </tr>
    ...
    <div class="datatable-container" id="all-product-cat-2-counterfeit-Annual-Percentage">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        <tbody>
          ...
          <tr>
            <td style="text-align:center; width:50%"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-counterfeit-annual-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-counterfeit-annual-alerts.png"></a>
            </td>
            <td style="text-align:center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-counterfeit-annual-alerts-percentage.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-counterfeit-annual-alerts-percentage.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-annual-alerts.png"></a>
            </td>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-total-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-action-required-total-alerts.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-ly-vs-ty.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-ly-vs-ty.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td style="width:50%">
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-annual-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-annual-alerts.png"></a>
            </td>
            <td>
              <a href="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-total-alerts.png">
                <img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-responsible-party-total-alerts.png"></a>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="datatable-container" id="all-product-cat-2-top30-brands">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tbody>
          <tr>
            <td style="text-align: center;"><a
                href="https://rodders.me/safetygate/img-2023/all-countries-product-2-top-30-brands-for-safety-alerts.png"><img
                  src="https://rodders.me/safetygate/img-2023/all-countries-product-2-top-30-brands-for-safety-alerts.png">
            </td>
          </tr>
        </tbody>
      </table>
...
<script>
  ...
  tippy('#all-AnnualGeoplot', {
    content: 'Submitting Country Previous Year Vs Current Year.',
    theme: 'tomato'
  });
  tippy('#all-submitting-country-ly-vs-ty', {
    content: 'Submitting Country Previous Year Vs Current Year percentage of safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-Cosmetics-Coo', {
    content: 'Cosmetics - Country of Product Origin Previous Year Vs Current Year.',
    theme: 'tomato'
  });
  ...
  tippy('#all-Economic-Area-ly-vs-ty', {
    content: 'Previous Year Vs Current Year comparison of Economic Area of Product Origin (Feature Engineered) by Percentage of total for top 15.',
    theme: 'tomato'
  });
  tippy('#all-Coo-ly-vs-ty', {
    content: 'Previous Year Vs Current Year comparison of percentage of safety alerts issued to Country of Product Origin.',
    theme: 'tomato'
  });
  ...
  tippy('#all-product-category-ly-vs-ty', {
    content: 'Product Category Previous Year Vs Current Year percentage of Total safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-risk-category-ly-vs-ty', {
    content: 'Risk Category type Previous Year Vs Current Year percentage of safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-counterfeit-ly-vs-ty', {
    content: 'Counterfeit type Previous Year Vs Current Year percentage of safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-action-required-ly-vs-ty', {
    content: 'Compulsory and Voluntary action required Previous Year Vs Current Year percentage of safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-responsible-ly-vs-ty', {
    content: 'Compulsory and Voluntary Responsible Party Previous Year Vs Current Year percentage of safety alerts.',
    theme: 'tomato'
  });
  ...
  tippy('#all-product-cat-0-submitting-country-ly-vs-ty', {
  ...
  tippy('#all-product-cat-0-risk-category-ly-vs-ty', {
  ...
  tippy('#all-product-cat-0-counterfeit-ly-vs-ty', {
  ...
  tippy('#all-product-cat-0-action-required-ly-vs-ty', {
  ...
  tippy('#all-product-cat-0-responsible-ly-vs-ty', {
  ...
  tippy('#all-product-cat-1-submitting-country-ly-vs-ty', {
  ...
  tippy('#all-product-cat-1-risk-category-ly-vs-ty', {
  ...
  tippy('#all-product-cat-1-counterfeit-ly-vs-ty', {
  ...
  tippy('#all-product-cat-1-action-required-ly-vs-ty', {
  ...
  tippy('#all-product-cat-1-responsible-ly-vs-ty', {
  ...
  tippy('#all-product-cat-2-submitting-country-ly-vs-ty', {
  ...
  tippy('#all-product-cat-2-risk-category-ly-vs-ty', {
  ...
  tippy('#all-product-cat-2-counterfeit-ly-vs-ty', {
  ...
  tippy('#all-product-cat-2-action-required-ly-vs-ty', {
  ...
  tippy('#all-product-cat-2-responsible-ly-vs-ty', {
