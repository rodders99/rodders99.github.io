...
<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a> -->
            ...
            <div class="countries">
              ...
              <select onchange="window.location.hash=this.value" class="country">
                ...
                <option value="header-4">Percentage of Total Worldwide Alerts</option>
                <option value="header-5">Country Annual, Cumulative and Year on Year change</option>
                <option value="header-6">Country Top 3 Product & Risk Categories</option>
                <option value="header-7">Country Product Category</option>
                <option value="header-10">Risk Category</option>
                <option value="header-13">Counterfeit</option>
                <option value="header-16">Action Required / Responsible Party</option>
                <option value="header-18">Submitting Country</option>
                <option value="header-20">Top 3 Product Categories</option>
                <option value="header-21">#1 - Top Product Category</option>
                <option value="header-23">#1 - Category Percentage of Country Alerts</option>
                <option value="header-24">#1 - Product Category Annual, Cumulative and Year on Year change</option>
                <option value="header-25">#1 - Product Category Risk Category</option>
                <option value="header-28">#1 - Product Category Counterfeit</option>
                <option value="header-31">#1 - Product Category Action Required / Responsible Party</option>
                <option value="header-33">#1 - Product Category Submitting Country</option>
                <option value="header-36">#1 - Product Category Top Brands</option>
                
                <option value="header-38">#2 - Top Product Category</option>
                <option value="header-39">#2 - Category Percentage of Country Alerts</option>
                <option value="header-40">#2 - Product Category Annual, Cumulative and Year on Year change</option>
                ...
                <option value="header-54">#3 - Top Product Category</option>
                <option value="header-55">#2 - Category Percentage of Country Alerts</option>
                <option value="header-56">#2 - Product Category Annual, Cumulative and Year on Year change</option>
                <option value="header-57">#3 - Product Category Risk Category</option>
                <option value="header-60">#3 - Product Category Counterfeit</option>
                <option value="header-63">#3 - Product Category Action Required / Responsible Party</option>
                <option value="header-65">#3 - Product Category Submitting Country</option>
                <option value="header-68">#3 - Product Category Top Brands</option>
    ...
    <p><img src="https://rodders.me/safetygate/img/icons/Safety_Gate_Logo.png" alt="Safety Gate Logo" style="width:49%"></p>
  ...
  <tbody> 
    ...
    <tr>
      <td style="align-items:center;  width:49%" id="country-total-alerts-vs-row">
        <a href="https://rodders.me/safetygate/img/all-total-alerts-issued-vs-row-percentage.png">
       <img src="https://rodders.me/safetygate/img/total-alerts-issued-vs-row-percentage.png" class="change" ></a></td>
      <td style="align-items:center;  width:49%" id="country-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-total-alerts-issued-vs-row-2022-vs-2023.png">
       <img src="https://rodders.me/safetygate/img/total-alerts-issued-vs-row-2022-vs-2023.png" class="change" ></a></td>
  </tr>
    ...
    <tr><th style="text-align:center;">Annual and Cumulative</th>
      ...
      <tr>
        <td style="align-items:top;  width:49%" id="country-annual-cumulative">
          <A href="https://rodders.me/safetygate/img/all-annual-and-cumulative-alerts.png">
            <img src="https://rodders.me/safetygate/img/annual-and-cumulative-alerts.png" class='change'/></a>
        <td style="align-items:top;width:49%" id="country-annual-yoy-change">
          <a href="https://rodders.me/safetygate/img/all-annual-cumulative-alerts-and-yoy-change.png">
            <img src="https://rodders.me/safetygate/img/annual-cumulative-alerts-and-yoy-change.png" class="change" ></a></td>
      </tr>
    </tbody>
  </table>
  <a href="#" class="gototop">Go to Top</a>
  ...
  <tbody> 
    <tr>
        ...
        <td style="text-align:center;" >
          <a href="https://rodders.me/safetygate/img/all-top3s.png">
            <img src="https://rodders.me/safetygate/img/top3s.png"  class="change" ></a></td>
  ...
  <tbody> 
    ...
    <tr>
      <td style="align-items: top; width:49%" id="product-category-percentage">
        <a href="https://rodders.me/safetygate/img/all-product-category-total-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/product-category-total-alerts-percentage.png" class="change" ></a></td>
      <td style=" width:49%; align-items: top" id="product-category-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-product-category-2022-vs-2023.png">
          <img src="https://rodders.me/safetygate/img/product-category-2022-vs-2023.png" class="change" ></a></td>
  </tr>
  </tbody>
</table>
<a href="#" class="gototop">Go to Top</a>
  ...
  <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
    ...
    <tr>
      <td style="align-items:top; width:49%" id="product-category-annual">
        <a href="https://rodders.me/safetygate/img/all-product-category-annual-alerts.png">
          <img src="https://rodders.me/safetygate/img/product-category-annual-alerts.png" class="change" ></a></td>
      <td style="align-items:top; width:49%" id="product-category-annual-percentage">
        <a href="https://rodders.me/safetygate/img/all-product-category-annual-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/product-category-annual-alerts-percentage.png"  class="change"></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <tbody> 
    ...
    <tr>
      <td style="text-align:center; width:49%" id="risk-category-percentage">
        <a href="https://rodders.me/safetygate/img/all-risk-category-total-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/risk-category-total-alerts-percentage.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="risk-category-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-risk-category-2022-vs-2023.png">
          <img src="https://rodders.me/safetygate/img/risk-category-2022-vs-2023.png" class="change" ></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
    ...
    <tr>
      <td style="text-align:center; width:49%" id="risk-category-annual">
        <a href="https://rodders.me/safetygate/img/all-risk-category-annual-alerts.png">
          <img src="https://rodders.me/safetygate/img/risk-category-annual-alerts.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="risk-category-annual-percentage" >
        <a href="https://rodders.me/safetygate/img/all-risk-category-annual-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/risk-category-annual-alerts-percentage.png" class="change" ></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <tbody> 
    ...
    <tr>
      <td style="text-align:center; width:49%" id="counterfeit-category-percentage">
        <a href="https://rodders.me/safetygate/img/all-counterfeit-total-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/counterfeit-total-alerts-percentage.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="counterfeit-category-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-counterfeit-total-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/counterfeit-2022-vs-2023.png" class="change" ></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
    ...
    <tr>
      <td style="text-align:center; width:49%" id="counterfeit-category-annual">
        <a href="https://rodders.me/safetygate/img/all-counterfeit-annual-alerts.png">
          <img src="https://rodders.me/safetygate/img/counterfeit-annual-alerts.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="counterfeit-category-annual-percentage">
        <a href="https://rodders.me/safetygate/img/all-counterfeit-annual-alerts-percentage.png">
        <img src="https://rodders.me/safetygate/img/counterfeit-annual-alerts-percentage.png"  class="change"></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <tbody> 
    ...
    <tr>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-action-required-2022-vs-2023.png">
          <img src="https://rodders.me/safetygate/img/action-required-2022-vs-2023.png"  class="change"></a></td>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-responsible-party-2022-vs-2023.png">
          <img src="https://rodders.me/safetygate/img/responsible-party-2022-vs-2023.png" class="change" ></a></td>
  </tr>
    <tr>
    ...
    <tr>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-annual">
        <a href="https://rodders.me/safetygate/img/all-action-required-annual-alerts.png">
          <img src="https://rodders.me/safetygate/img/action-required-annual-alerts.png"  class="change"></a></td>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-annual">
        <a href="https://rodders.me/safetygate/img/all-responsible-party-annual-alerts.png">
          <img src="https://rodders.me/safetygate/img/responsible-party-annual-alerts.png" class="change" ></a></td>
  </tr>
    <tr>
    ...
    <tr>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-total">
        <a href="https://rodders.me/safetygate/img/all-action-required-total-alerts.png">
          <img src="https://rodders.me/safetygate/img/action-required-total-alerts.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="action-required-responsible-party-total">
        <a href="https://rodders.me/safetygate/img/all-responsible-party-total-alerts.png">
          <img src="https://rodders.me/safetygate/img/responsible-party-total-alerts.png" class="change" ></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <tbody> 
    ...
    <tr>
      <td style="text-align:center; width:49%" id="submitting-country-percentage">
        <a href="https://rodders.me/safetygate/img/all-submitting-country-total-alerts-percentage.png">
          <img src="https://rodders.me/safetygate/img/submitting-country-total-alerts-percentage.png" class="change" ></a></td>
      <td style="text-align:center; width:49%" id="submitting-country-2022vs2023">
        <a href="https://rodders.me/safetygate/img/all-submitting-country-2022-vs-2023.png">
          <img src="https://rodders.me/safetygate/img/submitting-country-2022-vs-2023.png" class="change" ></a></td>
  </tr>
</tbody>
</table>
</div>
  ...
  <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
    ...
    <tr>
        <td style="text-align:center; width:49%" id="submitting-country-annual" >
          <a href="https://rodders.me/safetygate/img/all-submitting-country-annual-alerts.png">
            <img src="https://rodders.me/safetygate/img/submitting-country-annual-alerts.png"  class="change"></a></td>
        <td style="text-align:center; width:49%" id="submitting-country-annual-percentage">
          <a href="https://rodders.me/safetygate/img/all-submitting-country-annual-alerts-percentage.png">
            <img src="https://rodders.me/safetygate/img/submitting-country-annual-alerts-percentage.png"  class="change"></a></td>
    </tr>
</tbody>
</table>
</div>
...
<h3 class="product_cat0">Product Category - Percentage of Total</h3>
    ...
    <div class="datatable-container">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto" id="product-cat-0-percentage">
        ...
        <tr>
          <td style="text-align:center;" >
            <a href="https://rodders.me/safetygate/img/all-product-0-total-alerts-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-0-total-alerts-percentage-of-all.png" class="change" ></a></td>      
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
      ...
      <tr>
        <td style="text-align:center; width:49%" id="product-cat-0-annual-cumulative" >
          <a href="https://rodders.me/safetygate/img/all-product-0-annual-and-cumulative-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-0-annual-and-cumulative-alerts.png" class="change" ></a></td>
        <td style="text-align:center; width:49%" id="product-cat-0-annual-yoy-change">
          <a href="https://rodders.me/safetygate/img/all-product-0-annual-and-yoy-change.png">
            <img src="https://rodders.me/safetygate/img/product-0-annual-cumulative-alerts-and-yoy-change.png"  class="change"></a></td>
      </tr> 
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-risk-category-percentage">
            <a href="https://rodders.me//safetygate/img/all-product-0-risk-category-total-alerts-percentage.png">
              <img src="https://rodders.me/safetygate/img/product-0-risk-category-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-0-risk-category-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-0-risk-category-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-0-risk-category-2022-vs-2023.png"  class="change"></a></td>
      </tr> 
      </tbody>
      </table>
    </div>
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-0-risk-category-annual">
              <a href="https://rodders.me/safetygate/img/all-product-0-risk-category-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-0-risk-category-annual-alerts.png" class="change" ></a></td>
            <td style="text-align:center; width:49%" id="product-cat-0-risk-category-annual-percentage" >
              <a href="https://rodders.me/safetygate/img/all-product-0-risk-category-annual-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-0-risk-category-annual-alerts-percentage.png" class="change" ></a></td>
        </tr> 
      ...
      <tbody> 
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-counterfeit-type-percentage" >
            <a href="https://rodders.me/safetygate/img/all-product-0-total-counterfeit-type-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-0-counterfeit-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-0-counterfeit-type-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-0-total-counterfeit-type-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-0-counterfeit-2022-vs-2023.png"  class="change"></a></td>
        </tr> 
        </tbody>
      </table>
      ...
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-counterfeit-type-annual">
            <a href="https://rodders.me/safetygate/img/all-product-0-annual-counterfeit-alerts-issued.png">
              <img src="https://rodders.me/safetygate/img/product-0-counterfeit-annual-alerts.png" class="change" ></a></td>
          <td style="text-align:center;width:49%" id="product-cat-0-counterfeit-type-annual-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-0-annual-counterfeit-alerts-issued-percentage-by-type.png">
              <img src="https://rodders.me/safetygate/img/product-0-counterfeit-annual-alerts-percentage.png"  class="change"></a></td>
        </tr> 
      </tbody>
    </table>
<a href="#" class="gototop">Go to Top</a></div>
      ...
      <tbody> 
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-0-action-required-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-0-action-required-2022-vs-2023.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-0-responsible-party-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-0-responsible-party-2022-vs-2023.png" class="change" ></a></td>
      </tr>
        <tr>
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-annual">
            <a href="https://rodders.me/safetygate/img/all-product-0-action-required-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-0-action-required-annual-alerts.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-annual">
            <a href="https://rodders.me/safetygate/img/all-product-0-responsible-party-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-0-responsible-party-annual-alerts.png" class="change" ></a></td>
      </tr>
        <tr>
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-total">
            <a href="https://rodders.me/safetygate/img/all-product-0-action-required-total-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-0-action-required-total-alerts.png" class="change" ></a></td>
          <td style="text-align:center; width:49%" id="product-cat-0-action-required-responsible-party-total">
            <a href="https://rodders.me/safetygate/img/all-product-0-responsible-party-total-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-0-responsible-party-total-alerts.png" class="change" ></a></td>
      </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
    ...
    <div class="datatable-container">
        ...
        <tr>
            ...
            <td style="text-align:center; width:49%" id="product-cat-0-submitting-country-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-0-submitting-country-total-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-0-submitting-country-total-alerts-percentage.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-0-submitting-country-2022vs2023">
              <a href="https://rodders.me/safetygate/img/all-product-0-submitting-country-2022-vs-2023.png">
                <img src="https://rodders.me/safetygate/img/product-0-submitting-country-2022-vs-2023.png"  class="change"></a></td>
            </tr> 
            </tbody>
          </table>
          <a href="#" class="gototop">Go to Top</a>
    ...
    <h3  class="product_cat0" >Submitting Country - Annual, Cumulative and Year on Year change</h3>
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-0-submitting-country-annual">
              <a href="https://rodders.me/safetygate/img/all-product-0-submitting-country-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-0-submitting-country-annual-alerts.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-0-submitting-country-annual-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-0-submitting-country-annual-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-0-submitting-country-annual-percentage.png" class="change" ></a></td>
        </tr> 
...
<h3  class="product_cat0" >Top Brands for Safety Alerts</h3>
    ...
    <tbody>
    <tr >
    <td style="text-align: center;"><a href="https://rodders.me/safetygate/img/all-product-0-top-30-brands-for-safety-alerts.png"><img src="https://rodders.me/safetygate/img/product-0-top-30-brands-for-safety-alerts.png" class="change"></td>
    </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
...
<h3 class="product_cat1">Product Category - Percentage of Total</h3>
    ...
    <div class="datatable-container">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto" id="product-cat-1-percentage">
        ...
        <tr>
          <td style="text-align:center;" >
            <a href="https://rodders.me/safetygate/img/all-product-1-total-alerts-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-1-total-alerts-percentage-of-all.png" class="change" ></a></td>      
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
      ...
      <tr>
        <td style="text-align:center; width:49%" id="product-cat-1-annual-cumulative">
          <a href="https://rodders.me/safetygate/img/all-product-1-annual-and-cumulative-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-1-annual-and-cumulative-alerts.png" class="change" ></a></td>
        <td style="text-align:center; width:49%" id="product-cat-1-annual-yoy-change">
          <a href="https://rodders.me/safetygate/img/all-product-1-annual-and-yoy-change.png">
            <img src="https://rodders.me/safetygate/img/product-1-annual-cumulative-alerts-and-yoy-change.png"  class="change"></a></td>
      </tr> 
    ...
    <div class="datatable-container">
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-1-risk-category-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-1-risk-category-total-alerts-percentage.png">
              <img src="https://rodders.me/safetygate/img/product-1-risk-category-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-1-risk-category-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-1-risk-category-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-1-risk-category-2022-vs-2023.png"  class="change"></a></td>
      </tr> 
      </tbody>
      </table>
      <a href="#" class="gototop">Go to Top</a>
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-1-risk-category-annual">
              <a href="https://rodders.me/safetygate/img/all-product-1-risk-category-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-1-risk-category-annual-alerts.png" class="change" ></a></td>
            <td style="text-align:center; width:49%" id="product-cat-1-risk-category-annual-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-1-risk-category-annual-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-1-risk-category-annual-alerts-percentage.png" class="change" ></a></td>
        </tr> 
      ...
      <tbody> 
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-1-counterfeit-type-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-1-total-counterfeit-type-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-1-counterfeit-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-1-counterfeit-type-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-1-total-counterfeit-type-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-1-counterfeit-2022-vs-2023.png"  class="change"></a></td>
        </tr> 
        </tbody>
      </table>
<a href="#" class="gototop">Go to Top</a></div>
      ...
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-1-counterfeit-type-annual">
            <a href="https://rodders.me/safetygate/img/all-product-1-annual-counterfeit-alerts-issued.png">
              <img src="https://rodders.me/safetygate/img/product-1-counterfeit-annual-alerts.png" class="change" ></a></td>
          <td style="text-align:center; width:49%" id="product-cat-1-counterfeit-type-annual-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-1-annual-counterfeit-alerts-issued-percentage-by-type.png">
              <img src="https://rodders.me/safetygate/img/product-1-counterfeit-annual-alerts-percentage.png"  class="change"></a></td>
        </tr> 
      </tbody>
    </table>
<a href="#" class="gototop">Go to Top</a></div>
      ...
      <tbody> 
        ...
        <tr id="product-cat-1-action-required-responsible-party-2022vs2023">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-1-action-required-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-1-action-required-2022-vs-2023.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-1-responsible-party-2022-vs-2023.png">
            <img src="https://rodders.me/safetygate/img/product-1-responsible-party-2022-vs-2023.png" class="change" ></a></td>
      </tr>
        ...
        <tr id="product-cat-1-action-required-responsible-party-annual">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-1-required-action-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-1-action-required-annual-alerts.png"  class="change"></a></td>
          <td style="text-align:center;" >
            <a href="https://rodders.me/safetygate/img/all-product-1-responsible-party-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-1-responsible-party-annual-alerts.png" class="change" ></a></td>
      </tr>
        ...
        <tr id="product-cat-1-action-required-responsible-party-total">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-1-action-required-total-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-1-action-required-total-alerts.png" class="change" ></a></td>
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-1-responsible-party-total-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-1-responsible-party-total-alerts.png" class="change" ></a></td>
      </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
    ...
    <div class="datatable-container">
        ...
        <tr>
            ...
            <td style="text-align:center; width:49%" id="product-cat-1-submitting-country-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-1-submitting-country-total-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-1-submitting-country-total-alerts-percentage.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-1-submitting-country-2022vs2023" >
              <a href="https://rodders.me/safetygate/img/all-product-1-submitting-country-2022-vs-2023.png">
                <img src="https://rodders.me/safetygate/img/product-1-submitting-country-2022-vs-2023.png"  class="change"></a></td>
            </tr> 
            </tbody>
          </table>
          <a href="#" class="gototop">Go to Top</a>
    ...
    <h3  class="product_cat1" >Submitting Country - Annual, Cumulative and Year on Year change</h3>
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-1-submitting-country-annual" >
              <a href="https://rodders.me/safetygate/img/all-product-1-submitting-country-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-1-submitting-country-annual-alerts.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-1-submitting-country-annual-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-1-submitting-country-annual-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-1-submitting-country-annual-percentage.png" class="change" ></a></td>
        </tr> 
...
<h3  class="product_cat1" >Top Brands for Safety Alerts</h3>
    ...
    <tr >
    <td style="text-align: center;">
      <a href="https://rodders.me/safetygate/img/all-product-1-top-30-brands-for-safety-alerts.png">
        <img src="https://rodders.me/safetygate/img/product-1-top-30-brands-for-safety-alerts.png" class="change"></td>
    </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
...
<!-- Product 2 -->
<h2 class="">#3 - Product Category</h1>
...
<h3 class="product_cat2">Product Category - Percentage of Total</h3>
    ...
    <div class="datatable-container">
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto" id="product-cat-2-percentage">
        ...
        <tr>
          <td style="text-align:center;" >
            <a href="https://rodders.me/safetygate/img/all-product-2-total-alerts-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-2-total-alerts-percentage-of-all.png" class="change" ></a></td>      
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
      ...
      <tr>
        <td style="text-align:center; width:49%" id="product-cat-2-annual-cumulative">
          <a href="https://rodders.me/safetygate/img/all-product-2-annual-and-cumulative-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-2-annual-and-cumulative-alerts.png" class="change" ></a></td>
        <td style="text-align:center; width:49%" id="product-cat-2-annual-yoy-change">
          <a href="https://rodders.me/safetygate/img/all-product-2-annual-and-yoy-change.png">
            <img src="https://rodders.me/safetygate/img/product-2-annual-cumulative-alerts-and-yoy-change.png" class="change"></a></td>
      </tr> 
    ...
    <div class="datatable-container">
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-2-risk-category-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-2-risk-category-total-alerts-percentage.png">
              <img src="https://rodders.me/safetygate/img/product-2-risk-category-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-2-risk-category-2022vs2023">
            <a href="https://rodders.me/safetygate/img/all-product-2-risk-category-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-2-risk-category-2022-vs-2023.png"  class="change"></a></td>
      </tr> 
      </tbody>
      </table>
      <a href="#" class="gototop">Go to Top</a>
    ...
    <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-2-risk-category-annual">
              <a href="https://rodders.me/safetygate/img/all-product-2-risk-category-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-2-risk-category-annual-alerts.png" class="change" ></a></td>
            <td style="text-align:center; width:49%" id="product-cat-2-risk-category-annual-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-2-risk-category-annual-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-2-risk-category-annual-alerts-percentage.png" class="change" ></a></td>
        </tr> 
      ...
      <tbody> 
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-2-counterfeit-type-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-2-total-counterfeit-type-percentage-of-all.png">
              <img src="https://rodders.me/safetygate/img/product-2-counterfeit-total-alerts-percentage.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" id="product-cat-2-counterfeit-type-2022vs2023" >
            <a href="https://rodders.me/safetygate/img/all-product-2-total-counterfeit-type-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-2-counterfeit-2022-vs-2023.png"  class="change"></a></td>
        </tr> 
        </tbody>
        <a href="#" class="gototop">Go to Top</a></div>
      </table>
      ...
      <table class="datatable" style="margin-right:auto;margin-left:0px; width:auto">
        ...
        <tr>
          <td style="text-align:center; width:49%" id="product-cat-2-counterfeit-type-annual">
            <a href="https://rodders.me/safetygate/img/all-product-2-annual-counterfeit-alerts-issued.png">
              <img src="https://rodders.me/safetygate/img/product-2-counterfeit-annual-alerts.png" class="change" ></a></td>
          <td style="text-align:center; width:49%" id="product-cat-2-counterfeit-type-annual-percentage">
            <a href="https://rodders.me/safetygate/img/all-product-2-annual-counterfeit-alerts-issued-percentage-by-type.png">
              <img src="https://rodders.me/safetygate/img/product-2-counterfeit-annual-alerts-percentage.png"  class="change"></a></td>
        </tr> 
      </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
...
<h3  class="product_cat2" >Voluntary / Compulsory Action Required / Responsible Party</h3>
    ...
    <div class="datatable-container">
      ...
      <tbody> 
        ...
        <tr id="product-cat-2-action-required-responsible-party-2022vs2023">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-action-required-2022-vs-2023.png">
              <img src="https://rodders.me/safetygate/img/product-2-action-required-2022-vs-2023.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-responsible-party-2022-vs-2023.png">
            <img src="https://rodders.me/safetygate/img/product-2-responsible-party-2022-vs-2023.png" class="change" ></a></td>
      </tr>
        ...
        <tr id="product-cat-2-action-required-responsible-party-annual">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-action-required-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-2-action-required-annual-alerts.png"  class="change"></a></td>
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-responsible-party-annual-alerts.png">
              <img src="https://rodders.me/safetygate/img/product-2-responsible-party-annual-alerts.png" class="change" ></a></td>
      </tr>
        ...
        <tr id="product-cat-2-action-required-responsible-party-total">
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-action-required-total-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-2-action-required-total-alerts.png" class="change" ></a></td>
          <td style="text-align:center; width:49%" >
            <a href="https://rodders.me/safetygate/img/all-product-2-responsible-party-total-alerts.png">
            <img src="https://rodders.me/safetygate/img/product-2-responsible-party-total-alerts.png" class="change" ></a></td>
      </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
    ...
    <div class="datatable-container">
        ...
        <tr>
            ...
            <td style="text-align:center; width:49%" id="product-cat-2-submitting-country-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-2-submitting-country-total-alerts-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-2-submitting-country-total-alerts-percentage.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-2-submitting-country-2022vs2023">
              <a href="https://rodders.me/safetygate/img/all-product-2-submitting-country-2022-vs-2023.png">
                <img src="https://rodders.me/safetygate/img/product-2-submitting-country-2022-vs-2023.png"  class="change"></a></td>
            </tr> 
            </tbody>
          </table>
          <a href="#" class="gototop">Go to Top</a>
    ...
    <h3  class="product_cat2" >#3 - Submitting Country - Annual, Cumulative and Year on Year change</h3>
        ...
        <tr>
            <td style="text-align:center; width:49%" id="product-cat-2-submitting-country-annual">
              <a href="https://rodders.me/safetygate/img/all-product-2-submitting-country-annual-alerts.png">
                <img src="https://rodders.me/safetygate/img/product-2-submitting-country-annual-alerts.png"  class="change"></a></td>
            <td style="text-align:center; width:49%" id="product-cat-2-submitting-country-annual-percentage">
              <a href="https://rodders.me/safetygate/img/all-product-2-submitting-country-annual-percentage.png">
                <img src="https://rodders.me/safetygate/img/product-2-submitting-country-annual-percentage.png" class="change" ></a></td>
        </tr> 
...
<h3  class="product_cat2" >#3 - Top Brands for Safety Alerts</h3>
    ...
    <tr >
    <td style="text-align: center;">
      <a href="https://rodders.me/safetygate/img/all-product-2-top-30-brands-for-safety-alerts.png">
        <img src="https://rodders.me/safetygate/img/product-2-top-30-brands-for-safety-alerts.png" class="change"></td>
    </tr>
    </tbody>
    </table>
    <a href="#" class="gototop">Go to Top</a>
